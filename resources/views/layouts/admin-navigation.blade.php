    ...
    <nav class="bg-white border-b border-gray-100">
        ...
        <div v-bind:class="{ block: toggled, hidden: !toggled }" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('admin.states.index')" :active="request()->routeIs('admin.states.index')">
                    {{ __('States') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.cities.index')" :active="request()->routeIs('admin.cities.index')">
                    {{ __('Cities') }}
                </x-responsive-nav-link>
